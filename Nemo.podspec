#
#  Be sure to run `pod spec lint Nemo.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Jaehong Kang"
  # s.authors            = { "Jaehong Kang" => "sinoru@me.com" }
  # s.social_media_url   = "http://twitter.com/Jaehong Kang"
