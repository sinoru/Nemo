...
final public class PhotosMenuController: UIAlertController {
    ...
    public override func viewDidLoad() {
        ...
        self.photoLibraryAction = UIAlertAction(title: NSLocalizedString("Photo Library", tableName: "Nemo", bundle: Bundle.nemoBundle(), comment: ""), style: .default, handler: { (action) -> Void in
        ...
        self.cameraAction = UIAlertAction(title: NSLocalizedString("Take Photo or Video", tableName: "Nemo", bundle: Bundle.nemoBundle(), comment: ""), style: .default, handler: { (action) -> Void in
            let imagePickerController = UIImagePickerController()
            imagePickerController.delegate = self.delegate
        ...
        self.cancelAction = UIAlertAction(title: NSLocalizedString("Cancel", tableName: "Nemo", bundle: Bundle.nemoBundle(), comment: ""), style: .cancel,  handler: { (action) -> Void in
